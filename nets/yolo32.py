...
class SpatialPyramidPooling1(nn.Module):
    def __init__(self, pool_sizes=[9, 17, 25]):
...
class SpatialPyramidPooling2(nn.Module):
    def __init__(self, pool_sizes=[17, 33, 51]):
